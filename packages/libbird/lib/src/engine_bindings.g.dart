...
class LibbirdBindings {
  ...
  ffi.Pointer<ffi.Uint8> get_latest_frame(
    ffi.Pointer<ffi.Int> out_width,
    ffi.Pointer<ffi.Int> out_height,
  ) {
    return _get_latest_frame(out_width, out_height);
  }

  late final _get_latest_framePtr =
      _lookup<
        ffi.NativeFunction<
        ...
        >
      >('get_latest_frame');
  late final _get_latest_frame = _get_latest_framePtr
      .asFunction<
        ffi.Pointer<ffi.Uint8> Function(
          ffi.Pointer<ffi.Int>,
          ffi.Pointer<ffi.Int>,
