...
//     final macosBundleRoot = "${packageRoot}macos/Bundle";
//     // final macosBinariesRoot = "$macosResourcesRoot/binaries";
//     // final macos = "$macosResourcesRoot/binaries";
...
//     await Directory(macosBundleRoot).create();
...
//     await File(
//       "$cppBuildRoot/libengine.dylib",
//     ).copy("$macosBundleRoot/libengine.dylib");
//   });
// }
